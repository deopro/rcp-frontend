...
function parseRawOption(rawOption, optionPreprocessorFuncs, isNew) {
	...
	if (hasMedia) {
		if (isArray(mediaOnRoot)) each$2(mediaOnRoot, function(singleMedia) {
...
var Axis = function() {
	...
	*/
	Axis.prototype.getTicksCoords = function(opt) {
		...
		var preTicksCoords = map$1(result.ticks, function(tick) {
			return {
	...
	Axis.prototype.getMinorTicksCoords = function() {
		...
		return map$1(minorTicks, function(minorTicksGroup) {
...
//#endregion
export { isDimensionStacked as $, reformIntervals as $a, groupData as $i, getScaleBreakHelper as $n, updateProps as $r, defaultSeriesFormatTooltip as $t, isAxisOnBand as A, getPixelPrecision as Aa, COMPONENT_MAIN_TYPE_SERIES as Ai, getCircleLayout as An, getTransform as Ar, registerUpdateLifecycle as At, OrdinalScale as B, mathFloor as Ba, ListIterator as Bi, simpleCoordSysInjectionProvider as Bn, resizePath as Br, getCustomSeries as Bt, requireAxisStatistics as C, warn as Ca, leaveEmphasis as Ci, LOCATION_PARAMS as Cn, ensureCopyRect as Cr, registerMap as Ct, getAxisRawValue as D, getAcceptableTickPrecision as Da, setStatesStylesFromModel as Di, createBoxLayoutReference as Dn, extendShape as Dr, registerProcessor as Dt, determineAxisType as E, asc as Ea, setStatesFlag as Ei, copyLayoutParams as En, extendPath as Er, registerPreprocessor as Et, shouldShowAllLabels as F, isPositionSizeOptionPercent as Fa, SOURCE_FORMAT_ORIGINAL as Fi, sizeCalculable as Fn, makeImage as Fr, createSymbol as Ft, isIntervalOrLogScale as G, nice as Ga, convertOptionIdName as Gi, formatTpl as Gn, transformDirection as Gr, setItemVisualFromData as Gt, getIntervalPrecision as H, mathMin$2 as Ha, SINGLE_REFERRING as Hi, capitalFirst as Hn, setTooltipConfig as Hr, createLegacyDataSelectAction as Ht, updateIntervalOrLogScaleForNiceOrAligned as I, isRadianAroundZero as Ia, UNDEFINED_STR as Ii, CoordinateSystemManager as In, makePath as Ir, normalizeSymbolOffset as It, isTimeScale as J, parsePercent as Ja, defaultEmphasis as Ji, normalizeCssArray as Jn, getAnimationConfig as Jr, throttle as Jt, isLogScale as K, numericToNumber as Ka, createSimpleOverallStageHandler as Ki, formatTplSimple as Kn, traverseElements as Kr, clear as Kt, AXIS_TYPES as L, linearMap as La, getECData as Li, decideCoordSysUsageKind as Ln, mergePath as Lr, normalizeSymbolSize as Lt, isOnAxisZeroDiscouraged as M, getPrecisionSafe as Ma, SERIES_LAYOUT_BY_COLUMN as Mi, getLayoutRect as Mn, groupTransition as Mr, setCanvasCreator as Mt, retrieveAxisBreaksOption as N, isNullableNumberFinite as Na, SOURCE_FORMAT_ARRAY_ROWS as Ni, mergeLayoutParam as Nn, isBoundingRectAxisAligned as Nr, version as Nt, getScaleValuePositionKind as O, getPercentSeats as Oa, toggleHoverEmphasis as Oi, fetchLayoutMode as On, getCurrentCanvasPainter as Or, registerTheme as Ot, shouldAxisShow as P, isNumeric as Pa, SOURCE_FORMAT_OBJECT_ROWS as Pi, positionElement as Pn, linePolygonIntersect as Pr, createOrUpdatePatternFromDecal as Pt, getStackedDimension as Q, quantityExponent as Qa, getTooltipRenderMode as Qi, roundTime as Qn, saveOldStyle as Qr, SeriesModel as Qt, LogScale as R, mathAbs$2 as Ra, setCommonECData as Ri, injectCoordSysByOption as Rn, payloadDisableAnimation as Rr, symbolBuildProxies as Rt, registerMetricImpl as S, throwError as Sa, leaveBlur as Si, ComponentModel as Sn, decomposeTransform as Sr, registerLoading as St, createScaleByModel as T, addSafe as Ta, setDefaultStateProxy as Ti, box as Tn, expandOrShrinkRect as Tr, registerPostUpdate as Tt, increaseInterval as U, mathPI as Ua, clearTmpModel as Ui, convertToColorString as Un, subPixelOptimize as Ur, getItemVisualFromData as Ut, ensureValidSplitNumber as V, mathMax$2 as Va, MULTIPLE_REFERRING as Vi, addCommas as Vn, retrieveZInfo as Vr, findEventDispatcher as Vt, intervalScaleEnsureValidExtent as W, mathRound as Wa, compressBatches as Wi, formatTime as Wn, subPixelOptimizeLine as Wr, getVisualFromData as Wt, OrdinalMeta as X, quantile as Xa, getDataItemValue as Xi, windowOpen as Xn, removeElement as Xr, createRenderPlanner as Xt, getScaleExtentForMappingUnsafe as Y, parsePositionSizeOption as Ya, ensureExtentAscSimply as Yi, toCamelCase as Yn, initProps as Yr, ChartView as Yt, enableDataStack as Z, quantity as Za, getIncrementalId as Zi, format as Zn, removeElementWithFadeOut as Zr, ComponentView as Zt, associateSeriesWithAxis as _, deprecateLog as _a, enableHoverEmphasis as _i, getDecalFromPalette as _n, applyTransform as _r, init as _t, parseGeoJSON as a, makeInternalComponentId as aa, BezierCurve as ai, SourceManager as an, Model as ar, DataDiffer as at, eachSeriesDealForAxisStat as b, log as ba, enterEmphasis as bi, makeSeriesEncodeForNameBased as bn, clipRectByRect as br, registerCustomSeries as bt, contain as c, normalizeToArray as ca, Polygon as ci, createFilterComparator as cn, createTextConfig as cr, dataTool as ct, scaleCalcNice2 as d, preparePipelineContext as da, Ellipse as di, parseSanitizationFilter as dn, getLabelStatesModels as dr, disconnect as dt, initExtentForUnion as ea, IncrementalDisplayable as ei, TooltipMarkupStyleCreator as en, remRadian as eo, hasBreaks as er, createDimensions as et, scaleCalcNiceDirectly as f, queryDataIndex as fa, Circle as fi, passesSanitizationFilter as fn, labelInner as fr, dispose as ft, scaleRawExtentInfoEnableBoxCoordSysUsage as g, validateUpstreamOutputRange as ga, enableComponentHighDownFeatures as gi, createSourceFromSeriesDataOption as gn, XY as gr, getMap as gt, scaleRawExtentInfoCreate as h, unionExtentFromNumber as ha, SPECIAL_STATES as hi, retrieveRawValue as hn, WH as hr, getInstanceById as ht, createAxisLabelsComputingContext as i, makeInner as ia, Arc as ii, retrieveVisualColorForTooltipMarker as in, inheritDefaultOption as ir, getDimensionTypeByAxis as it, isNameLocationCenter as j, getPrecision as ja, ROAM_ACTION_TYPE_SUFFIX as ji, getLayoutParams as jn, graphic_exports as jr, registerVisual as jt, getTickValueOutermost as k, getPercentWithPrecision as ka, getViewOfComponentOrSeries as ki, getBoxLayoutParams as kn, getShapeClass as kr, registerTransform as kt, use as l, parseFinder as la, Ring as li, getRawValueParser as ln, createTextStyle as lr, dependencies as lt, registerAxisContainShapeHandler as m, removeDuplicates as ma, DISPLAY_STATES as mi, normalizeTooltipFormatResult as mn, setLabelValueAnimation as mr, getInstanceByDom as mt, calcBandWidth as n, isNameSpecified as na, RadialGradient as ni, createTooltipMarkup as nn, roundLegacy as no, registerLocale as nr, SeriesData as nt, GeoJSONRegion as o, makeQueryConditionKindA as oa, Line as oi, disableTransformOptionMerge as on, LabelMarginType as or, PRIORITY as ot, adoptScaleRawExtentInfoAndPrepare as p, queryReferringComponents as pa, createFromString as pi, DataFormatMixin as pn, setLabelStyle as pr, getCoordinateSystemDimensions as pt, isOrdinalScale as q, parseDate as qa, createSimpleOverallStageHandler2 as qi, getTooltipMarker as qn, traverseUpdateZ as qr, createOrUpdate as qt, AxisTickLabelComputingKind as r, makeCallOnlyOnce as ra, LinearGradient as ri, getPaddingFromTooltipModel as rn, __extends as ro, getUID as rr, createDimNameMap as rt, GeoSVGRegion as s, mappingToExists as sa, Polyline as si, SortOrderComparator as sn, animateLabelValue as sr, connect as st, Axis as t, interpolateRawValues as ta, OrientedBoundingRect as ti, buildTooltipMarkup as tn, round as to, getLocaleModel as tr, prepareSeriesDataSchema as tt, scaleCalcNice as u, preParseFinder as ua, Sector as ui, parseDataValue as un, getFont as ur, disConnect as ut, countSeriesOnAxisOnKey as v, deprecateReplaceLog as va, enableHoverFocus as vi, registerInternalOptionCreator as vn, calcZ2Range as vr, registerAction as vt, AxisModelCommonMixin as w, MAX_SAFE_INTEGER as wa, setAsHighDownDispatcher as wi, applyPreserveAspect as wn, ensureCopyTransform as wr, registerPostInit as wt, eachSeriesOnAxisOnKey as x, makePrintable as xa, isHighDownDispatcher as xi, tokens as xn, createIcon as xr, registerLayout as xt, eachAxisOnKey as y, error as ya, enterBlur as yi, makeSeriesEncodeForAxisCoordSys as yn, clipPointsByRect as yr, registerCoordinateSystem as yt, IntervalScale as z, mathCeil as za, makeStyleMapper as zi, registerLayOutOnCoordSysUsage as zn, registerShape as zr, getCachePerECPrepare as zt };
