...
//#endregion
export { boundingRectApplyTransform as $, map as $n, getMatrixStr as $t, getLineDash as A, disableUserSelect as An, max$1 as At, containStroke$4 as B, isArrayLike as Bn, create$1 as Bt, subPixelOptimize as C, assert as Cn, copy as Ct, encodeHTML as D, createHashMap as Dn, distance as Dt, CompoundPath as E, concatArray as En, distSquare as Et, DEFAULT_PATH_STYLE as F, find as Fn, set as Ft, devicePixelRatio as G, isNumber as Gn, rotate as Gt, normalizeArcAngles as H, isFunction as Hn, invert as Ht, Path as I, hasOwn as In, sub as It, getBoundingRect as J, isString as Jn, __extends as Jt, env as K, isObject as Kn, scale$1 as Kt, windingLine as L, indexOf as Ln, vector_exports as Lt, truncateText as M, eqNaN as Mn, normalize as Mt, createOrUpdateImage as N, extend as Nn, scale as Nt, transformLocalCoord as O, curry as On, len as Ot, ZRImage as P, filter as Pn, scaleAndAdd as Pt, BoundingRect as Q, logError as Qn, getIdURL as Qt, normalizeRadian as R, inherits as Rn, clone$1 as Rt, Rect as S, LRU as Sn, clone as St, subPixelOptimizeRect as T, clone$2 as Tn, dist$1 as Tt, fromPoints as U, isGradientObject as Un, matrix_exports as Ut, PathProxy as V, isDom as Vn, identity as Vt, Displayable as W, isImagePatternObject as Wn, mul$1 as Wt, parsePercent as X, isTypedArray as Xn, adjustTextY$1 as Xt, getLineHeight as Y, isStringSafe as Yn, TEXT_ALIGN_TO_ANCHOR as Yt, Eventful as Z, keys as Zn, encodeBase64 as Zt, normalizeEvent as _, modifyAlpha as _n, copyTransform as _t, getCanvasGradient as a, isGradient as an, reduce as ar, Point as at, hasSeparateFont as b, parseCssFloat as bn, add as bt, init as c, isPattern as cn, retrieve3 as cr, cubicAt as ct, zrender_exports as d, round4 as dn, trim as dr, cubicSubdivide as dt, getPathPrecision as en, merge as er, boundingRectCalculateTransform as et, Group as f, color_exports as fn, util_exports as fr, quadraticAt as ft, isMiddleOrRightButtonOnMouseUpDown as g, liftColor as gn, setPlatformAPI as gr, Transformable as gt, addEventListener as h, lift as hn, platformApi as hr, TRANSFORMABLE_PROPS as ht, createCanvasPattern as i, isAroundZero$1 as in, normalizeCssArray as ir, createIntersectContext as it, TSpan as j, each as jn, min$1 as jt, transformLocalCoordClear as k, defaults as kn, lerp as kt, registerPainter as l, isRadialGradient as ln, setAsPrimitive as lr, cubicDerivativeAt as lt, sort as m, lerp$1 as mn, DEFAULT_FONT_FAMILY as mr, quadraticSubdivide as mt, brushLoopFinalize as n, getShadowKey as nn, mixin as nr, boundingRectCopy as nt, getSize as o, isImagePattern as on, retrieve as or, cloneValue as ot, requestAnimationFrame as p, fastLerp as pn, DEFAULT_FONT as pr, quadraticDerivativeAt as pt, calculateTextPosition as q, isRegExp as qn, translate as qt, brushSingle as r, hasShadow as rn, noop as rr, boundingRectCreate as rt, getElementSSRData as s, isLinearGradient as sn, retrieve2 as sr, createCubicEasingFunc as st, brush as t, getSRTTransformString as tn, mergeAll as tr, boundingRectContain as tt, registerSSRDataGetter as u, normalizeColor as un, slice as ur, cubicRootAt as ut, stop as v, modifyHSL as vn, transformableCreate as vt, subPixelOptimizeLine as w, bind as wn, create as wt, parseFontSize as x, stringify as xn, applyTransform as xt, ZRText as y, parse as yn, transformableGetLocalTransform as yt, containStroke$2 as z, isArray as zn, copy$1 as zt };
