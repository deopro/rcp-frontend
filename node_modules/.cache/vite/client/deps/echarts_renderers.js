import { $n as map, $t as getMatrixStr, A as getLineDash, An as disableUserSelect, Cn as assert, D as encodeHTML, Dn as createHashMap, E as CompoundPath, F as DEFAULT_PATH_STYLE, G as devicePixelRatio, Gn as isNumber, Hn as isFunction, I as Path, Jn as isString, Jt as __extends, K as env, Kn as isObject, N as createOrUpdateImage, Nn as extend, P as ZRImage, Pn as filter, Q as BoundingRect, Qn as logError, Qt as getIdURL, Tn as clone, Un as isGradientObject, V as PathProxy, Wn as isImagePatternObject, Xt as adjustTextY, Y as getLineHeight, Yt as TEXT_ALIGN_TO_ANCHOR, Z as Eventful, Zn as keys, Zt as encodeBase64, _t as copyTransform, a as getCanvasGradient, an as isGradient, b as hasSeparateFont, cn as isPattern, dn as round4, en as getPathPrecision, er as merge, gn as liftColor, hr as platformApi, i as createCanvasPattern, in as isAroundZero, j as TSpan, jn as each, ln as isRadialGradient, n as brushLoopFinalize, nn as getShadowKey, o as getSize, on as isImagePattern, p as requestAnimationFrame, r as brushSingle, rn as hasShadow, rr as noop, s as getElementSSRData, sn as isLinearGradient, sr as retrieve2, st as createCubicEasingFunc, t as brush$1, tn as getSRTTransformString, un as normalizeColor, x as parseFontSize, zn as isArray } from "./graphic-DqEtHgEG.js";
...
function removeVnodes(parentElm, vnodes, startIdx, endIdx) {
	for (; startIdx <= endIdx; ++startIdx) {
		var ch = vnodes[startIdx];
		if (ch != null) {
			if (isDef(ch.tag)) removeChild(parentNode(ch.elm), ch.elm);
