import { $n as getScaleBreakHelper, $r as updateProps, A as isAxisOnBand, Ai as COMPONENT_MAIN_TYPE_SERIES, Ar as getTransform$1, Ba as mathFloor, C as requireAxisStatistics, Ca as warn, Ci as leaveEmphasis, Cr as ensureCopyRect, Da as getAcceptableTickPrecision, Dn as createBoxLayoutReference, E as determineAxisType, Ea as asc, F as shouldShowAllLabels, Fa as isPositionSizeOptionPercent, Ft as createSymbol$1, G as isIntervalOrLogScale, Ga as nice, Gr as transformDirection, H as getIntervalPrecision, Ha as mathMin$1, Hi as SINGLE_REFERRING, Hr as setTooltipConfig, I as updateIntervalOrLogScaleForNiceOrAligned, Ia as isRadianAroundZero, It as normalizeSymbolOffset, J as isTimeScale, Ja as parsePercent, Ji as defaultEmphasis, Jr as getAnimationConfig, K as isLogScale, Kr as traverseElements, Kt as clear, L as AXIS_TYPES, La as linearMap, Li as getECData, Ln as decideCoordSysUsageKind, Lr as mergePath, Lt as normalizeSymbolSize, M as isOnAxisZeroDiscouraged, Mn as getLayoutRect, Mr as groupTransition, N as retrieveAxisBreaksOption, Na as isNullableNumberFinite, Nn as mergeLayoutParam, Nr as isBoundingRectAxisAligned, O as getScaleValuePositionKind, Oi as toggleHoverEmphasis, On as fetchLayoutMode, P as shouldAxisShow, Pt as createOrUpdatePatternFromDecal, Qr as saveOldStyle, Qt as SeriesModel, R as LogScale, Ra as mathAbs, Rn as injectCoordSysByOption, Rr as payloadDisableAnimation, S as registerMetricImpl, Sn as ComponentModel, Sr as decomposeTransform, T as createScaleByModel, Ta as addSafe, Ti as setDefaultStateProxy, Tr as expandOrShrinkRect, U as increaseInterval, Ua as mathPI, V as ensureValidSplitNumber, Va as mathMax$1, Vr as retrieveZInfo, Vt as findEventDispatcher, W as intervalScaleEnsureValidExtent, Wa as mathRound, Wr as subPixelOptimizeLine, X as OrdinalMeta, Xr as removeElement, Y as getScaleExtentForMappingUnsafe, Ya as parsePositionSizeOption, Yr as initProps, Za as quantity, Zt as ComponentView, _ as associateSeriesWithAxis, _r as applyTransform, a as parseGeoJSON, ai as BezierCurve, ar as Model, at as DataDiffer, b as eachSeriesDealForAxisStat, ba as log, bi as enterEmphasis, bn as makeSeriesEncodeForNameBased, ca as normalizeToArray, ci as Polygon, di as Ellipse, dn as parseSanitizationFilter, dr as getLabelStatesModels, eo as remRadian, er as hasBreaks, fi as Circle, fn as passesSanitizationFilter, g as scaleRawExtentInfoEnableBoxCoordSysUsage, gi as enableComponentHighDownFeatures, gr as XY, h as scaleRawExtentInfoCreate, hi as SPECIAL_STATES, hn as retrieveRawValue, hr as WH, i as createAxisLabelsComputingContext, ia as makeInner, j as isNameLocationCenter, ji as ROAM_ACTION_TYPE_SUFFIX, jn as getLayoutParams, k as getTickValueOutermost, ki as getViewOfComponentOrSeries, li as Ring, lr as createTextStyle, n as calcBandWidth, ni as RadialGradient, nn as createTooltipMarkup, nt as SeriesData, o as GeoJSONRegion, oa as makeQueryConditionKindA, oi as Line$1, or as LabelMarginType, p as adoptScaleRawExtentInfoAndPrepare, pi as createFromString, pr as setLabelStyle, q as isOrdinalScale, qt as createOrUpdate, r as AxisTickLabelComputingKind, ri as LinearGradient, ro as __extends, rr as getUID, rt as createDimNameMap, s as GeoSVGRegion, si as Polyline, t as Axis, ti as OrientedBoundingRect, to as round, tt as prepareSeriesDataSchema, u as scaleCalcNice, vt as registerAction, w as AxisModelCommonMixin, wa as MAX_SAFE_INTEGER, wn as applyPreserveAspect, wr as ensureCopyTransform, xn as tokens, ya as error, yr as clipPointsByRect, z as IntervalScale, za as mathCeil, zi as makeStyleMapper } from "./Axis-Cfw8ZZUt.js";
import { $n as merge, An as each$1, B as TRANSFORMABLE_PROPS, Bt as copy$1, Cn as bind, D as Displayable, Dn as curry, En as createHashMap, F as Group, Fn as hasOwn, Ft as boundingRectCopy, Gn as isObject$1, Gt as mul, H as copyTransform, Ht as identity, In as indexOf, It as boundingRectCreate, Jt as translate, K as cloneValue, Kt as rotate, Mn as extend, Mt as boundingRectApplyTransform, Nn as filter, Nt as boundingRectCalculateTransform, On as defaults, Pn as find, Pt as boundingRectContain, Qn as map, Qt as stop, Rn as isArray, Rt as Point, Sn as assert, U as transformableCreate, Ut as invert, V as Transformable, Vn as isFunction, Vt as create, W as transformableGetLocalTransform, Wn as isNumber, Xn as keys, Xt as isMiddleOrRightButtonOnMouseUpDown, _ as TSpan, _t as parse, ar as retrieve, c as CompoundPath, dt as fastLerp, er as mergeAll, f as Rect, g as ZRImage, gt as modifyHSL, hn as normalize, ht as modifyAlpha, in as applyTransform$1, ir as reduce, jn as eqNaN, jt as BoundingRect, l as ZRText, mn as min, nn as Eventful, nr as noop, on as copy, or as retrieve2, pn as max, qn as isString, qt as scale, sr as retrieve3, tr as mixin, ur as trim, vn as set, vt as parseCssFloat, wn as clone, y as Path, yn as sub, yt as stringify, zn as isArrayLike } from "./graphic-CU091wIj.js";
...
var View = function(_super) {
	...
	*/
	View.prototype.getRoamTransform = function() {
		return transformableGetLocalTransform(inner$2(this).trans[1]);
	};
	View.prototype.dataToPoint = function(data, noRoam, out) {
		var transform = noRoam ? inner$2(this).mtRaw : inner$2(this).mtOverall;
		out = out || [];
		return transform ? applyTransform$1(out, data, transform) : copy(out, data);
	};
	View.prototype.pointToData = function(point, reserved, out) {
		out = out || [];
		var invTransform = inner$2(this).mtOverallInv;
...
function viewCoordSysCopyOverallMatrix(out, viewCoordSys) {
	return copy$1(out || [], inner$2(viewCoordSys).mtOverall);
}
function viewCoordSysGetZoomOption(viewCoordSys) {
	return inner$2(viewCoordSys).zoom;
}
function viewCoordSysCopyBoundingRect(out, viewCoordSys) {
	return boundingRectCopy(out || boundingRectCreate(), inner$2(viewCoordSys).dataRect);
}
function viewCoordSysCopyViewRect(out, viewCoordSys) {
	return boundingRectCopy(out || boundingRectCreate(), inner$2(viewCoordSys).viewRect);
}
function viewCoordSysCopyTrans(out, viewCoordSys, transKind) {
	return copyTransform(out || transformableCreate(), inner$2(viewCoordSys).trans[transKind]);
}
...
function viewCoordSysSetRoamOptionFromModel(viewCoordSys, hostModel) {
	var viewInner = inner$2(viewCoordSys);
...
//#endregion
export { viewCoordSysSetBoundingRect as $, MapDraw as A, mapSeriesGroupHasOwnGeo as B, install as C, getAxisBreakHelper as Ct, BrushController as D, makeRectPanelClipPath as E, shiftLayoutOnXY as Et, updateRoamControllerSimply as F, calcCompensationScaleToPreserveNodeSize as G, createSeriesDataSimply as H, RoamController as I, isViewCoordSys as J, clampByZoomLimit as K, MapSeries as L, createViewCoordSysSimply as M, isRoamPayloadHasZoom as N, sliderMove as O, registerRoamActionSimply as P, viewCoordSysGetZoomOption as Q, buildAllMapSeriesGroups as R, warnDeprecated as S, axisModelCreator as St, makeRectIsTargetByCursor as T, computeLabelGeometry as Tt, View as U, mapSeriesNeedsDrawMap as V, applyViewCoordSysTransToElement as W, viewCoordSysCopyOverallMatrix as X, viewCoordSysCopyBoundingRect as Y, viewCoordSysCopyTrans as Z, isTransitionAll as _, getCartesianAxisHashKey as _t, LineDraw as a, createBandWidthBasedAxisContainShapeHandler as at, convertToEC4StyleForCustomSerise as b, AxisBuilder as bt, SymbolDraw as c, makeAxisStatKey2 as ct, getDefaultLabel as d, rectCoordAxisBuildSplitArea as dt, viewCoordSysSetViewRect as et, VisualMapping as f, rectCoordAxisHandleRemove as ft, applyUpdateTransition as g, makeKey as gt, applyLeaveTransition as h, getAxisInfo as ht, isGeoLikeCoordSys as i, requireAxisStatisticsForBaseBar as it, createIsInSelfByPointerCheckerEl as j, install$1 as k, Symbol as l, createFloat32Array as lt, stopPreviousKeyframeAnimationAndRestore as m, collect as mt, injectThumbnailBridge as n, SERIES_TYPE_PICTORIAL_BAR as nt, Line as o, createMetricsNonOrdinalLinearPositiveMinGap as ot, applyKeyframeAnimation as p, AxisView as pt, getOwnRoamViewCoordSys as q, isCoordinateSystemType as r, getStartValue as rt, ECLinePath as s, makeAxisStatKey as st, getThumbnailBridge as t, install$2 as tt, getDefaultInterpolatedLabel as u, install$3 as ut, updateLeaveTo as v, isCartesian2DInjectedAsDataCoordSys as vt, makeLinearBrushOtherExtent as w, COORD_SYS_TYPE_CARTESIAN_2D as wt, isEC4CompatibleStyle as x, Axis2D as xt, convertFromEC4CompatibleStyle as y, layout as yt, getMainMapSeries as z };
