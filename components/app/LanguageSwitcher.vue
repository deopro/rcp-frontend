...
<template>
  <label class="inline-flex items-center text-sm text-muted">
    ...
    <select
      class="touch-target appearance-none bg-transparent px-1 text-sm font-medium text-muted transition-colors hover:text-foreground focus:outline-none"
      :value="locale"
